...
export const PharmacyLayout: React.FC<PharmacyLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { label: 'Inventory', path: '/pharmacy/inventory', icon: '💊' },
    { label: 'Low Stock Alerts', path: '/pharmacy/low-stock', icon: '⚠️' },
    { label: 'Reservation Requests', path: '/pharmacy/reservations', icon: '📋' },
    { label: 'Inventory History', path: '/pharmacy/inventory-history', icon: '📜' },
    { label: 'Analytics', path: '/pharmacy/analytics', icon: '📈' },
    { label: 'Notifications', path: '/pharmacy/notifications', icon: '🔔', badge: unreadNotificationCount },
    { label: 'Pharmacy Profile', path: '/pharmacy/profile', icon: '🏬' },
  ];
