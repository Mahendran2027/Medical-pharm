  ...
  return (
    <PharmacyLayout>
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-3">
              <h1 className="text-2xl font-bold text-slate-900">Pharmacy Notifications</h1>
              {unreadCount > 0 && (
            ...
            <p className="text-xs sm:text-sm text-slate-600 mt-1">
              Store alerts for new reservation holds, low-stock warnings, and admin verification messages.
            </p>
          </div>
        ...
        {isLoading ? (
          <LoadingSpinner label="Loading pharmacy notifications..." />
        ) : notifications.length === 0 ? (
          <EmptyState
            title="No Notifications"
            description="You currently have no notification alerts for your pharmacy."
          />
        ) : (
